...
const Home = () => {
	...
	return (
		<main>
			{/* hero */}
			<section>
				<div className='relative mx-auto flex max-w-screen-xl flex-col items-center px-2 pt-10 lg:flex-row lg:pt-20'>
					<div className='order-2 mt-6 flex max-w-[70ch] flex-col items-center text-center lg:order-1 lg:mt-0 lg:items-start lg:text-left'>
						<h2 className='text-3xl font-bold leading-tight lg:text-6xl lg:leading-[72px]'>
							Launch lead generation Google ads campaigns fast with a
							dedicated landing page
						</h2>
						<p className='max-w-[505px] pt-7 text-base md:text-xl md:leading-8'>
			...
			<section className='mt-20 bg-[#CDD4F4]'>
				<div className='mx-auto flex max-w-screen-xl flex-col items-center gap-10 px-3 py-20 lg:px-1'>
					<h2 className='text-center text-4xl font-bold leading-[43px]'>
						How it works
					</h2>

					<ul className='relative z-10 flex flex-col gap-4 after:absolute after:top-1/2 after:left-0 after:-z-10 after:h-5 after:w-full after:translate-y-1/2 after:bg-[#A2D6F9] md:grid md:grid-cols-4 md:gap-6'>
						{howitWorks.map(({ body, icon, title }) => (
							<li
								className='rounded-sx bg-white p-6 transition ease-in-out hover:scale-105 hover:bg-wustomers-main hover:text-white'
								key={title}
							>
