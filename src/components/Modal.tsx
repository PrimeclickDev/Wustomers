	...
	return (
		<Dialog.Root open={modalOpen} onOpenChange={closeModal}>
			<Dialog.Portal>
				...
				<Dialog.Content className='absolute top-1/2 left-1/2 z-50 max-h-[650px] w-full max-w-md -translate-x-1/2 -translate-y-1/2 animate-contentShow overflow-auto rounded-sx bg-white p-6 shadow-2xl focus:outline-none'>
					{children}
